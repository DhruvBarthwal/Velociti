...
const History = () => {
  ...
  return (
    <div className="history bg-white/10 backdrop-blur-lg border border-white/30 shadow-lg p-4 h-[calc(100vh-100px)] w-[220px] rounded-2xl ml-6 text-white flex flex-col font-sans">
